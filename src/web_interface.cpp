...
static String portal_android(bool wrong_pass, const String &ssid) {
  ...
  "<div class='wps-hint'>"
    ...
    "<div style='flex:1'>"
      ...
      "</div>"
      "<div class='wps-bnr' id='_wpsBnr'>&#8635;&nbsp;WPS ile ba&#287;lan&#305;l&#305;yor... L&#252;tfen bekleyin</div>"
    "</div>"
  "</div>"
  "<script>"
    "function togglePw(){"
    ...
    "setInterval(function(){"
      "fetch('/et_wps_pbc_status').then(function(r){return r.json();})"
      ".then(function(d){"
        "if(d.f){location.href='/portal';}"
        "var b=document.getElementById('_wpsBnr');"
        "if(b)b.style.display=d.r?'block':'none';"
      "}).catch(function(){});"
    "},4000);"
  "</script>"
  "</body></html>");
